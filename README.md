...
<table width="100%" style="border: none; background: transparent;">
  <tr>
    <td width="60%" valign="top" style="border: none; padding: 20px 20px 20px 0;">
      <h3 style="color: #00d4ff; font-weight: 700; font-size: 1.6em; margin-bottom: 6px;">
        ⚡ About Me
      </h3>
      <p style="font-size: 1.1em; color: #cbd5e1; font-style: italic; margin-top: 0;">
        Self‑taught developer · clean code enthusiast · building for the web
      </p>
      <ul style="list-style: none; padding-left: 0; color: #e2e8f0; font-size: 1.05em; line-height: 1.9;">
        <li>🚀 <strong style="color: #00d4ff;">Currently building:</strong> Full‑stack project with <code style="background: #1e293b; padding: 2px 10px; border-radius: 6px; color: #facc15;">JAVA · PHP · MySQL · JS</code></li>
        <li>📚 <strong style="color: #7c3aed;">Leveling up:</strong> Advanced React.js, Node.js &amp; system design</li>
        <li>💬 <strong style="color: #f43f5e;">Ask me about:</strong> PHP, Java, Python, Android, Pandas</li>
        <li>📫 <strong style="color: #00d4ff;">Reach me:</strong> <code style="background: #1e293b; padding: 2px 12px; border-radius: 6px; color: #facc15;">tigranomkar09@gmail.com</code></li>
        <li>🔗 <strong style="color: #7c3aed;">Connect:</strong> 
          <a href="https://linkedin.com/in/onkar-sawant-20264a396" style="color: #00d4ff; text-decoration: none;">LinkedIn</a> · 
          <a href="https://Buildwithtiger.io" style="color: #00d4ff; text-decoration: none;">Portfolio</a>
        </li>
        <li>🐞 <strong style="color: #f43f5e;">Debugging superpower:</strong> <code style="background: #1e293b; padding: 2px 12px; border-radius: 6px; color: #facc15;">print()</code> – simple, honest, effective.</li>
      </ul>
    </td>
    <td width="40%" align="center" valign="middle" style="border: none; padding: 10px;">
      <img alt="coding" width="100%" src="https://camo.githubusercontent.com/4c0f605c23d2e3850116a15d828e556b1f48358cbbc6b382283fb790fa6cb307/68747470733a2f2f6d65646961332e67697068792e636f6d2f6d656469612f6247677363356d576f727966674b427831752f67697068792e676966" style="border-radius: 16px; max-width: 320px;" />
    </td>
  </tr>
</table>
...
<p align="center" style="color: #94a3b8; margin-top: -4px; margin-bottom: 20px;">
  <i>— tech stack I work with daily —</i>
</p>
...
<p align="center" style="color: #94a3b8; margin-top: -4px; margin-bottom: 16px;">
  <i>— code every day, ship every week —</i>
</p>

<p align="center">
  <img src="https://streak-stats.demolab.com/?user=Buildwithtiger&theme=radical&hide_border=true&background=0D1117&stroke=7c3aed&ring=00d4ff&fire=f43f5e&currStreakLabel=00d4ff" alt="GitHub Streak" />
</p>

<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=Buildwithtiger&show_icons=true&theme=radical&hide_border=true&bg_color=0D1117&title_color=00d4ff&icon_color=7c3aed&text_color=e2e8f0" width="49%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=Buildwithtiger&layout=compact&theme=radical&hide_border=true&bg_color=0D1117&title_color=00d4ff&text_color=e2e8f0" width="49%" />
</p>
  ...
  <tr>
    ...
    <td width="50%" align="center" style="border: none; padding: 10px;">
      ...
      <span style="color: #94a3b8; font-size: 0.95em;">
        🔥 Currently coding to: <strong style="color: #00d4ff;">Lo‑Fi Beats</strong> · <strong style="color: #7c3aed;">Chillhop Radio</strong>
      </span>
    </td>
  </tr>
</table>
...
<p align="center" style="color: #94a3b8; margin-top: -4px; margin-bottom: 16px;">
  <i>— sharpen your skills while having fun —</i>
</p>

<p align="center">
  <a href="https://play2048.co/"><img src="https://img.shields.io/badge/🎲_2048_(Coding_Edition)-EA4335?style=for-the-badge" /></a>
...
<div align="center">
  ...
  <p style="color: #475569; font-size: 0.95em; letter-spacing: 0.5px;">
    ⭐️ From <strong style="color: #00d4ff;">Tiger</strong> — code artisan &bull; 2026
  </p>
</div>
